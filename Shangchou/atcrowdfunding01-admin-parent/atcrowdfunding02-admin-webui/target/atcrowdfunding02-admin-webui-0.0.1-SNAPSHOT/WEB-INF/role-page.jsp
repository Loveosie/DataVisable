...
<script type="application/javascript" src="crowd/my-role.js"></script>
<script type="text/javascript">
    ...
    $(function(){
        ...
        // 6.给页面上的“铅笔”按钮绑定单击响应函数，目的是打开模态框; 并回显
        ...
        $("#assignBtn").click(function () {
            ...
            //发送请求执行分配: roleId: 1; authIdArray: [1,4,5]
            var requestBody = {
