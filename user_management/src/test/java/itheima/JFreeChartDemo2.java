...
public class JFreeChartDemo2 {
	public static void main(String[] args) throws IOException {
		...
		JFreeChart lineChart = ChartFactory.createLineChart("部门招聘人数图","部门类别","人数",dataSet);
		ChartUtils.saveChartAsPNG(new File("d:\\linechart.png"),lineChart,1000,500);
	}
}
