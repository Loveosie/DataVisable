 ...
 * @description: 使用POI创建低版本excel, 并写入一段话
 * @author: lance
...
public class POIDemo1 {
    ...
    private static void opreateHighLevel() throws IOException {
        ...
        Sheet sheet = workbook.createSheet("一个POI创建的低版本excel");
    ...
    private static void opreateLowLevel() throws IOException {
        ...
        Cell cell = rowOne.createCell(0);
        cell.setCellValue("这是第一行的第一个单元格");
        workbook.write(new FileOutputStream("a.xls"));
